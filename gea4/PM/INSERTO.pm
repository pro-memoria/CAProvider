...
sub _listrecords_ead {
	...
	my $sql = q[
	SELECT RecordID AS object_id, RecordID as idno, Titolo as name, '1' as is_preferred, 'inserto' as item_value, parentid parent_uuid,
	Contenuto as scopecontent, inserto_nr numero,
